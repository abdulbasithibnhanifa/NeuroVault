 ...
 */
export function stringToColor(str: string, isDark: boolean = true): string {
  let hash = 0;
 ...
 */
export function stringToRGBA(str: string, opacity: number = 0.1, isDark: boolean = true): string {
